...
public class DefineEvaluationProgram implements Task {

    private final List<Map<String, String>> activities;

    public DefineEvaluationProgram(List<Map<String, String>> activities) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        for (int i = 0; i < activities.size(); i++) {
            ...
            if (i > 0) {
                actor.attemptsTo(
                        Click.on(EvaluationProgramModal.ADD_ACTIVITY_BUTTON)
                );
                actor.attemptsTo(WaitForMilliseconds.of(500));
            }
    ...
    public static DefineEvaluationProgram withActivities(List<Map<String, String>> activities) {
        return Tasks.instrumented(DefineEvaluationProgram.class, activities);
    }
}
